...
var ToachableBounce = require('ToachableBounce');
	...
	render() {
		...
		return (
			<View style={styles.overlay}>
				...
				<ToachableBounce onPress={this.props.onRestart}>
...
class Game2048 extends React.Component {
	...
	restartGame() {
		this.setState({board: new GameBoar()});
	}
...
AppRegistry.registerComponent('twoZeroFourEight', () => Game2048);
