...
var NoneSelected = React.createClass({
	render: function() {
		return (
			<div styles={styles.noneSelected} className='none-selected' role='alert'>
	...
	render: function() {
		...
		return (
			<div>
				...
				<div style={styles.emailViewer} className='email-viewer'>
					{selected_email}
				</div>
			</div>
		);
...
var MailboxList = React.createClass({
	render: function() {
		...
		return (
			<div style={styles.colMd2} className='column'>
				<ul style={styles.mailboxes} className='mailboxes list-group'>
					{mailbox_list}
				</ul>
			</div>
		);
	...
	render: function() {
		...
		return (
			<div className='app'>
				...
				<div style={styles.mailbox} className='mailbox'>
